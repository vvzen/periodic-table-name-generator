const elementsFile = "src/json/periodic-table-of-elements.json";
const elementsNameFile = "src/json/elements-symbols.json";
...
$.getJSON(elementsFile, function (data) {
    ...
    $.getJSON(elementsNameFile, function (data) {
        var elementsSymbols = data;
        console.log(elementsSymbols[0]);
